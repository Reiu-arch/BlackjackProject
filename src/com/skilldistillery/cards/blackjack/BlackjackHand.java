...
public class BlackjackHand extends AbstractHand {
	...
	// if number in hand is equal to 21 then it is blackjack, if not then not
	// blackjack
	...
	// if number in hand is over 21 then handValue is bust, if under or equal to 21
	// then not bust.
	...
	// need to flesh out gethandvalue.....maybe a for each card add the card value
	// and return handvalue to gethandvalue
